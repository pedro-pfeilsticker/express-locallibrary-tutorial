...
// Virtual for author's date lifespan
AuthorSchema
.virtual('date_lifespan')
.get(function() {
  var lifetime_string = (this.date_of_birth) ? DateTime.fromJSDate(this.date_of_birth).toLocaleString(DateTime.DATE_MED) : '';
  lifetime_string += ' - ';
